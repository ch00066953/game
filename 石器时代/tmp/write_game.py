...
target = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'game.js')
# Actually use a hardcoded path
target = r'd:\github\game\game\石器时代\game.js'
